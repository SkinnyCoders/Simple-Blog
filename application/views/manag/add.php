		...
		?>
			<form action="" method="POST">
				<div class="form-group">
					...
					<input type="text" name="mobil" class="form-control" id="formGroupExampleInput" value="<?= set_value('mobil') ?>" placeholder="Masukkan Nama">
				...
				<div class="form-group">
					...
					<input type="date" name="tahun" class="form-control" id="formGroupExampleInput2" value="<?= set_value('tahun') ?>" placeholder="Masukkan tahun">
					<small class="text-danger"><?= form_error('tahun') ?></small>
				</div>
				<div class="form-group">
					<label for="formGroupExampleInput2">Harga</label>
					<input type="text" name="harga" class="form-control" id="formGroupExampleInput2" value="<?= set_value('harga') ?>" placeholder="Masukkan harga">
